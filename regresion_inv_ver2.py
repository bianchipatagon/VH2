...
Hver = '../datos/VIENTOvsH_VER.nc'
OLRver = '../datos/VIENTOvsOLR_VER.nc'
Tver = '../datos/VvsT_ver.nc'
PPver = '../datos/VvsPP_ver.nc'
elevat = '../datos/elev.0.5-deg.nc'
...
Hinv = '../datos/VIENTOvsH_INV.nc'
OLRinv = '../datos/VIENTOvsOLR_INV.nc'
Tinv = '../datos/VIENTOvsT_INV.nc'
PPinv = '../datos/VvsPP_inv.nc'

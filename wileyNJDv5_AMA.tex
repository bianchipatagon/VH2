...
In this study, we will assess low-frequency variability and complementarity of solar and wind resources, and streamflows over three important basins over Argentina, considering different hydrologic regimes and climatic controls.
...
\begin{figure}[hbpt]
	\centering
	\hspace*{-1cm}   
	\includegraphics[clip,width=80mm]{fig1.png}
...
\begin{figure}[hbpt]
	\centering
	\hspace*{0cm}   
	\includegraphics[clip,width=90mm]{fig2.png}
	\caption{\label{variables} Time series monthly of wind speeds averaged at all wind sites (a), solar radiation averaged at all solar sites (b), and streamflows of the Neuquén, Limay and Santa Cruz Rivers (c, d and e). Vertical black discontinuous line indicates the year 2016}
\end{figure}
...
Solar time series were averaged into one time series since its temporal behavior is relatively homogeneous. Wind time series, instead, show very distinct temporal variations according to their location (see \cite{bianchi2019spatiotemporal}). These time series were clustered into 9 groups using a correlation matrix: all sites showing correlation coefficients above .8 were included in the same group (see fig ~\ref{series}).
...
\begin{figure}[hbpt]
	\centering
	\hspace*{0cm}   
	\includegraphics[clip,width=90mm]{fig7.png}
...
\begin{figure*}[hbpt]
	...
	\caption{\label{matriz2} Seasonal correlation matrices between climate indices and solar, wind and hydro time series}
\end{figure*}

\begin{figure*}[hbpt]
	\centering
	\hspace*{-1cm}   
	\includegraphics[clip,width=140mm]{fig9.png}
...
\begin{figure}[hbpt]
	\centering
	\hspace*{0cm}   
	\includegraphics[clip,width=80mm]{fig10.png}
...
\begin{figure}[hbpt]
	\centering
	\hspace*{-1cm}   
	\includegraphics[clip,width=80mm]{fig11.png}
...
\begin{figure}[hbpt]
	\centering
	\hspace*{0cm}   
	\includegraphics[clip,width=90mm]{fig12.png}
